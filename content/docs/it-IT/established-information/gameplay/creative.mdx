...
- Specchio Axis (Combo Box: Nessuna, Sconosciute altre opzioni): Descrizione sconosciuta al dicembre 2025.
...
- Macerie: genera macerie nel punto in cui sta guardando il giocatore.
- Tentacle: TBD
- Crepe laviche: trasforma il terreno in una crepa lavica nel punto in cui il giocatore sta guardando.
- Hot Springs: TBD
...
- Erba: TBD
- Montagna: posiziona blocchi consecutivi di terreno per formare una montagna nel punto in cui il giocatore sta guardando.
- Rovini: TBD
...
### Imposta strumento di ancoraggio
